...
interface JobDetailsViewProps {
  ...
  // Optional components that can be passed in from the consuming app
  DateSelector?: React.ComponentType<{
    date: Date | null;
    value: string;
    onChange: (date: Date | null) => void;
  }>;
  LinkOutIcon?: React.ComponentType;
}
    ...
    >
      <header>
        ...
        <a className="job-number jobber-link" href={job.webUri} target="_blank" title={`Open job #${job.jobNumber} on getjobber.com`}>
          Job #{job.jobNumber}{LinkOutIcon && <LinkOutIcon />}
        </a>
      </header>
