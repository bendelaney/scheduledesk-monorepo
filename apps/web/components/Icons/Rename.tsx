...
const SvgRename = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" width={11} height={11} {...props}>
    ...
    <path d="M8.205.48a1.637 1.637 0 0 1 2.315 2.315l-4.63 4.63a.6.6 0 0 1-.28.16l-1.95.487a.603.603 0 0 1-.732-.732l.488-1.95a.6.6 0 0 1 .158-.28zm1.462.853a.43.43 0 0 0-.609 0L4.545 5.845l-.203.812.813-.203 4.512-4.512a.43.43 0 0 0 .056-.542z" />
  </svg>
);
